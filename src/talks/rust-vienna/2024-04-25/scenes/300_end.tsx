...
export default makeScene2D(function* (view) {
  ...
  view.add(
    ...
    >
      <Rect direction={"column"} width={"100%"} alignItems={"center"} layout>
        <Txt ref={title} fontSize={120} fill={"white"} />
        <Txt ref={subtitle} fontSize={120} fill={"white"} />
      </Rect>
    ...
    chain(
      ...
      all(
        ...
        subtitle()
          ...
          .to(subtitleTo, 2.5, easeInOutQuad),
      ),
    ),
  );
  ...
  yield* all(
    ...
    chain(
      waitFor(0),
      all(name().opacity(1, 1), name().text(nameTo, 2.5, easeInOutQuad)),
    ),
